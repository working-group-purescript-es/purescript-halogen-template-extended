(() => {
  ...
  var IsSymbol = function(reflectSymbol2) {
    this.reflectSymbol = reflectSymbol2;
  };
  ...
  var EqRecord = function(eqRecord2) {
    this.eqRecord = eqRecord2;
  };
  var Eq = function(eq2) {
    this.eq = eq2;
  };
  ...
  var eqRec = function(dictRowToList) {
    return function(dictEqRecord) {
      return new Eq(eqRecord(dictEqRecord)($$Proxy.value));
    };
  };
  ...
  var Generic = function(from3, to2) {
    this.from = from3;
    this.to = to2;
  };
  ...
  var indexl = function(dictFoldable) {
    return function(idx) {
      ...
      var $315 = foldl(dictFoldable)(go2)({
        elem: Nothing.value,
        pos: 0
      });
      return function($316) {
  ...
  var lookup = function(dictFoldable) {
    return function(dictEq) {
      return function(a2) {
        var $320 = unwrap();
        var $321 = foldMap(dictFoldable)(monoidFirst)(function(v) {
          var $302 = eq(dictEq)(a2)(v.value0);
          if ($302) {
  ...
  var FunctorWithIndex = function(Functor0, mapWithIndex5) {
    this.Functor0 = Functor0;
    this.mapWithIndex = mapWithIndex5;
  };
  ...
  var Foldable1 = function(Foldable0, foldMap12, foldl13, foldr13) {
    this.Foldable0 = Foldable0;
  ...
  var foldMap1DefaultL = function(dictFoldable1) {
    return function(dictFunctor) {
      return function(dictSemigroup) {
        return function(f) {
          var $115 = foldl1(dictFoldable1)(append(dictSemigroup));
          var $116 = map(dictFunctor)(f);
          return function($117) {
            return $115($116($117));
          };
        };
        ...
        return function($copy_v) {
          ...
          function $tco_loop(a2, as3, v) {
            if (v instanceof Cons && eq(eqOrdering)(cmp(a2)(v.value0))(GT.value)) {
              $tco_var_a = v.value0;
              $tco_var_as = new Cons(a2, as3);
              $copy_v = v.value1;
              return;
            }
            ;
            $tco_done1 = true;
            return new Cons(new Cons(a2, as3), sequences(v));
          }
          ;
          while (!$tco_done1) {
      ...
      return function($copy_as) {
        return function($copy_v) {
          ...
          function $tco_loop(a2, as3, v) {
            ...
            ;
            $tco_done2 = true;
            return new Cons(as3(singleton3(a2)), sequences(v));
          }
          ;
          while (!$tco_done2) {
            $tco_result = $tco_loop($tco_var_a, $tco_var_as, $copy_v);
  ...
  var empty2 = new CatQueue(Nil.value, Nil.value);
  ...
  var traversableCatQueue = new Traversable(function() {
    ...
    return function(f) {
      var $100 = map(dictApplicative.Apply0().Functor0())(foldl(foldableCatQueue)(snoc2)(empty2));
      var $101 = foldl(foldableCatQueue)(function(acc) {
        var $103 = lift2(dictApplicative.Apply0())(snoc2)(acc);
        return function($104) {
          return $103(f($104));
        };
      })(pure(dictApplicative)(empty2));
      return function($102) {
        return $100($101($102));
      };
    };
  ...
  var traversableCatList = new Traversable(function() {
    ...
    return function(v) {
      ...
      if (v instanceof CatCons) {
        ...
        return apply(dictApplicative.Apply0())(map(dictApplicative.Apply0().Functor0())(cons3)(v.value0))(sequence(traversableCatList)(dictApplicative)(d));
      }
      ;
    ...
    return function(v) {
      return function(v1) {
        ...
        if (v1 instanceof CatCons) {
          ...
          return apply(dictApplicative.Apply0())(map(dictApplicative.Apply0().Functor0())(cons3)(v(v1.value0)))(traverse(traversableCatList)(dictApplicative)(v)(d));
        }
        ;
  ...
  var Free = function() {
    function Free3(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    Free3.create = function(value0) {
      return function(value1) {
        return new Free3(value0, value1);
      };
    };
    return Free3;
  }();
  ...
  var monadAskReaderT = function(dictMonad) {
    return new MonadAsk(function() {
      return monadReaderT(dictMonad);
    }, pure(dictMonad.Applicative0()));
  };
  var monadEffectReader = function(dictMonadEffect) {
    return new MonadEffect(function() {
  ...
  var extendList2 = new Extend(function() {
    ...
    return function(l) {
      var go2 = function(a2) {
        return function(v2) {
          var acc$prime = cons4(a2)(v2.acc);
          return {
            val: cons4(f(acc$prime))(v2.val),
            acc: acc$prime
          };
        };
      };
      ...
      ;
      if (v instanceof Cons2) {
        return cons4(f(l))(foldr(foldableList2)(go2)({
          val: nil,
          acc: nil
        })(v.value1).val);
      }
  ...
  var extendNonEmptyList2 = new Extend(function() {
    ...
    return function(v) {
      var go2 = function(a2) {
        return function(v12) {
          return {
            val: cons4(f(defer2(function(v2) {
              return new NonEmpty(a2, v12.acc);
            })))(v12.val),
            acc: cons4(a2)(v12.acc)
          };
        };
      };
      var v1 = force(v);
      ...
      return function(xs) {
        var v = function() {
          var rev3 = foldl(foldableList2)(function(v1) {
            return function(a2) {
              return new Tuple(v1.value0 + 1 | 0, cons4(a2)(v1.value1));
            };
          });
  ...
  var traversableList2 = new Traversable(function() {
    ...
    return function(f) {
      return foldr(foldableList2)(function(a2) {
        return function(b2) {
          return apply(dictApplicative.Apply0())(map(dictApplicative.Apply0().Functor0())(cons4)(f(a2)))(b2);
        };
  ...
  var traversableWithIndexList2 = new TraversableWithIndex(function() {
    ...
    return function(f) {
      return foldrWithIndex(foldableWithIndexList2)(function(i2) {
        return function(a2) {
          return function(b2) {
            return apply(dictApplicative.Apply0())(map(dictApplicative.Apply0().Functor0())(cons4)(f(i2)(a2)))(b2);
          };
        };
      })(pure(dictApplicative)(nil));
    };
  ...
  var applyNonEmptyList2 = new Apply(function() {
    ...
    return function(v1) {
      ...
      return defer2(function(v4) {
        return new NonEmpty(v3.value0(v2.value0), append(semigroupList2)(apply(applyList2)(v3.value1)(cons4(v2.value0)(nil)))(apply(applyList2)(cons4(v3.value0)(v3.value1))(v2.value1)));
      });
    };
  });
      ...
      return function(ys) {
        var go2 = function(v) {
          return function(v1) {
            ...
            ;
            if (v instanceof Cons2 && v1 instanceof Cons2) {
              return new Cons2(f(v.value0)(v1.value0), zipWith3(f)(v.value1)(v1.value1));
            }
            ;
  ...
  var unzip2 = foldr(foldableList2)(function(v) {
    return function(v1) {
      return new Tuple(cons4(v.value0)(v1.value0), cons4(v.value1)(v1.value1));
    };
  })(new Tuple(nil, nil));
  ...
  var eqMap = function(dictEq) {
    return function(dictEq1) {
      return new Eq(function(m1) {
        return function(m2) {
          return eq(eqArray(eqTuple(dictEq)(dictEq1)))(toAscArray(m1))(toAscArray(m2));
        };
      });
    };
  };
  var ordMap = function(dictOrd) {
    return function(dictOrd1) {
      return new Ord(function() {
        ...
        return function(m2) {
          return compare(ordArray(ordTuple(dictOrd)(dictOrd1)))(toAscArray(m1))(toAscArray(m2));
        };
      });
    };
  };
  ...
  var monadAffReader = function(dictMonadAff) {
    return new MonadAff(function() {
      ...
      var $25 = lift(monadTransReaderT)(dictMonadAff.MonadEffect0().Monad0());
    ...
    return function(dictIsSymbol) {
      return function(dictOrd) {
        return function(sym) {
          return function(key) {
            return function(v) {
              return lookup2(ordTuple(ordString)(ordOrdBox))(new Tuple(reflectSymbol(dictIsSymbol)(sym), mkOrdBox(dictOrd)(key)))(v);
            };
          };
        };
      };
      ...
      return function(dictOrd) {
        return function(sym) {
          return function(key) {
            return function(val) {
              return function(v) {
                return insert(ordTuple(ordString)(ordOrdBox))(new Tuple(reflectSymbol(dictIsSymbol)(sym), mkOrdBox(dictOrd)(key)))(val)(v);
              };
            };
          };
        };
  ...
  var subscribe2 = function(es) {
    return HalogenM(liftF(new Subscribe(function(v) {
      return es;
    }, identity(categoryFn))));
  };
  var raise = function(o) {
    return HalogenM(liftF(new Raise(o, unit)));
  };
    ...
    return function(dictIsSymbol) {
      return function(dictOrd) {
        return function(label5) {
          return function(p2) {
            return function(q2) {
              return HalogenM(liftF(ChildQuery2.create(mkChildQueryBox(new ChildQuery(function(dictApplicative) {
                return function(k) {
      ...
      return function(v) {
        var go2 = function(v1) {
          ...
          if (v1 instanceof Par) {
            return new Par(over()()(HalogenAp)(hoistFreeAp(hoist(dictFunctor)(nat)))(v1.value0));
          }
          ;
  ...
  var MonadLog = function(Monad0, logMessage2) {
    this.Monad0 = Monad0;
  ...
  var monadLogHalogenM = function(dictMonadLog) {
    return new MonadLog(function() {
      return monadHalogenM;
    }, function() {
      var $2 = lift(monadTransHalogenM)(dictMonadLog.Monad0());
      var $3 = logMessage(dictMonadLog);
      return function($4) {
        return $2($3($4));
      };
    }());
  ...
  var MonadNavigate = function(Monad0, logoutUser2, navigate2) {
    this.Monad0 = Monad0;
    this.logoutUser = logoutUser2;
  ...
  var monadNavigateHalogenM = function(dictMonadNavigate) {
    return new MonadNavigate(function() {
      return monadHalogenM;
    }, lift(monadTransHalogenM)(dictMonadNavigate.Monad0())(logoutUser(dictMonadNavigate)), function() {
      var $2 = lift(monadTransHalogenM)(dictMonadNavigate.Monad0());
      var $3 = navigate(dictMonadNavigate);
      return function($4) {
        return $2($3($4));
      };
    }());
  ...
  var MonadUser = function(Monad0, loginUser2) {
    this.Monad0 = Monad0;
  ...
  var monadUserHalogenM = function(dictMonadUser) {
    return new MonadUser(function() {
      return monadHalogenM;
    }, function() {
      var $2 = lift(monadTransHalogenM)(dictMonadUser.Monad0());
      var $3 = loginUser(dictMonadUser);
      return function($4) {
        return $2($3($4));
      };
    }());
  ...
  var GenericShowArgs = function(genericShowArgs2) {
    this.genericShowArgs = genericShowArgs2;
  };
  var GenericShow = function(genericShow$prime2) {
    this["genericShow'"] = genericShow$prime2;
  };
  ...
  var genericShowNoConstructors = new GenericShow(function(a2) {
    return genericShow$prime(genericShowNoConstructors)(a2);
  });
  ...
  var foldable1NonEmptyArray = new Foldable1(function() {
    return foldableNonEmptyArray;
  }, function(dictSemigroup) {
    return foldMap1DefaultL(foldable1NonEmptyArray)(functorNonEmptyArray)(dictSemigroup);
  }, foldl1Impl, foldr1Impl);
  var traversable1NonEmptyArray = new Traversable1(function() {
    ...
    return traverse1Impl(apply(dictApply))(map(dictApply.Functor0()));
  });
  ...
  var take4 = new Chomp(function(state3) {
    var v = uncons5(state3.segments);
    if (v instanceof Just) {
      return new Success({
  ...
  var rest = new Chomp(function(state3) {
    return new Success({
      segments: [],
      params: state3.params,
      hash: state3.hash
    ...
    var splitAt4 = function(k) {
      return function(p2) {
        return function(str2) {
          ...
          if (v instanceof Just) {
            return new Tuple(take3(v.value0)(str2), drop3(v.value0 + length7(p2) | 0)(str2));
          }
          ;
          if (v instanceof Nothing) {
            return k(str2);
  ...
  var $$int = function() {
    var $252 = maybe(new Left("Int"))(Right.create);
    return function($253) {
      return $252(fromString($253));
    };
  }();
  var hash = new Chomp(function(state3) {
    return new Success(state3, state3.hash);
  });
  var genericRouteResult = new Generic(function(x) {
  ...
  var genericRouteError = new Generic(function(x) {
  ...
  var showRouteError = new Show(genericShow(genericRouteError)(genericShowSum(genericShowConstructor(genericShowArgsProduct(genericShowArgsArgument(showString))(genericShowArgsArgument(showString)))(new IsSymbol(function() {
    return "Expected";
  })))(genericShowSum(genericShowConstructor(genericShowArgsArgument(showString))(new IsSymbol(function() {
    return "ExpectedEndOfPath";
  })))(genericShowSum(genericShowConstructor(genericShowArgsArgument(showString))(new IsSymbol(function() {
    return "MissingParam";
  })))(genericShowConstructor(genericShowArgsNoArguments)(new IsSymbol(function() {
    return "EndOfPath";
  })))))));
  var functorRouteResult = new Functor(function(f) {
    return function(m) {
  ...
  var functorRouteParser = new Functor(function(f) {
    return function(m) {
      if (m instanceof Alt2) {
        return new Alt2(map(functorNonEmptyArray)(map(functorRouteParser)(f))(m.value0));
      }
      ;
      if (m instanceof Chomp) {
        return new Chomp(map(functorFn)(map(functorRouteResult)(f))(m.value0));
      }
      ;
  ...
  var eqRouteError = new Eq(function(x) {
    return function(y) {
  ...
  var end = new Chomp(function(state3) {
  ...
  var chompPrefix = function(pre2) {
    return function(state3) {
      ...
      ;
      if (v instanceof Just) {
        return Fail.create(new Expected(pre2, v.value0));
      }
      ;
      ...
      return function($copy_v) {
        ...
        function $tco_loop(state3, v) {
          if (v instanceof Alt2) {
            $tco_done = true;
            return foldl(foldableNonEmptyArray)(goAlt(state3))(new Fail(EndOfPath.value))(v.value0);
          }
          ;
  ...
  var lazyRouteParser = new Lazy(function(k) {
    var parser = defer2(k);
    return new Chomp(function(state3) {
      return runRouteParser(state3)(force(parser));
    });
  });
      ...
      return function(p2) {
        return new Chomp(function(state3) {
          ...
          if (v instanceof Success) {
            ...
            if (v1 instanceof Left) {
              return Fail.create(new Expected(v1.value0, print7(v.value1)));
            }
            ;
            if (v1 instanceof Right) {
  ...
  var applyRouteParser = new Apply(function() {
  ...
  var applicativeRouteParser = new Applicative(function() {
    ...
    return function(v) {
      ...
      if (v instanceof Prefix) {
        ...
        if ($197 instanceof Prefix) {
          ...
          if ($198) {
            return snoc$prime(init4(ls))(new Prefix(v.value0, alt(altRouteParser)($197.value1)(v.value1)));
          }
          ;
          return v1(true);
        }
  ...
  var altRouteParser = new Alt(function() {
    return functorRouteParser;
  }, function(v) {
    return function(v1) {
      if (v instanceof Alt2 && v1 instanceof Alt2) {
        return new Alt2(altAppend(v.value0)(v1.value0));
      }
      ;
      if (v instanceof Alt2) {
        return new Alt2(altSnoc(v.value0)(v1));
      }
      ;
      if (v1 instanceof Alt2) {
        return new Alt2(altCons(v)(v1.value0));
      }
      ;
      ...
      ;
      return new Alt2(cons6(v)(singleton9(v1)));
    };
  });
    ...
    return function(rs) {
      ...
      if (v instanceof Prefix) {
        ...
        if ($217 instanceof Prefix) {
          ...
          if ($218) {
            return cons$prime(new Prefix(v.value0, alt(altRouteParser)(v.value1)($217.value1)))(tail2(rs));
          }
          ;
          return v1(true);
        }
      ...
      function $tco_loop(ls, rs) {
        ...
        if ($227 instanceof Prefix) {
          ...
          if ($228 instanceof Prefix) {
            ...
            if ($229) {
              var rs$prime = cons$prime(new Prefix($227.value0, alt(altRouteParser)($227.value1)($228.value1)))(tail2(rs));
  ...
  var semigroupRoutePrinter = new Semigroup(function(v) {
    return function(v1) {
      return function($25) {
        return v1(v($25));
      };
  ...
  var newtypeRoutePrinter = new Newtype(function() {
    return void 0;
  });
  var run4 = function() {
  ...
  var monoidRoutePRinter = new Monoid(function() {
  ...
  var segment = new RouteDuplex(put2, take4);
  var rest2 = new RouteDuplex(foldMap(foldableArray)(monoidRoutePRinter)(put2), rest);
  var record = new RouteDuplex(mempty(monoidFn(monoidRoutePRinter)), pure(applicativeRouteParser)({}));
  var profunctorRouteDuplex = new Profunctor(function(f) {
    return function(g) {
      return function(v) {
  ...
  var path = function() {
    var $103 = flip(foldr(foldableArray)(prefix2));
    var $104 = split("/");
    return function($105) {
      return $103($104($105));
    };
  ...
  var functorRouteDuplex = new Functor(function(f) {
    return function(m) {
      return new RouteDuplex(m.value0, map(functorRouteParser)(f)(m.value1));
    };
  });
  var end2 = function(v) {
    return new RouteDuplex(v.value0, applyFirst(applyRouteParser)(v.value1)(end));
  };
  ...
  var as2 = function(f) {
    return function(g) {
      return function(v) {
        return new RouteDuplex(function($106) {
          return v.value0(f($106));
  ...
  var applyRouteDuplex = new Apply(function() {
    return functorRouteDuplex;
  }, function(v) {
    return function(v1) {
      return new RouteDuplex(apply(applyFn)(map(functorFn)(append(semigroupRoutePrinter))(v.value0))(v1.value0), apply(applyRouteParser)(v.value1)(v1.value1));
    };
  });
  var applicativeRouteDuplex = new Applicative(function() {
    return applyRouteDuplex;
  }, function() {
    var $107 = RouteDuplex.create($$const(mempty(monoidRoutePRinter)));
    var $108 = pure(applicativeRouteParser);
    return function($109) {
      return $107($108($109));
    };
  }());
  ...
  var GRouteDuplexCtr = function(gRouteDuplexCtr2) {
    this.gRouteDuplexCtr = gRouteDuplexCtr2;
  };
  var GRouteDuplex = function(gRouteDuplex2) {
    this.gRouteDuplex = gRouteDuplex2;
  };
  var noArgs = pure(applicativeRouteDuplex)(NoArguments.value);
  var gRouteProduct = new GRouteDuplexCtr(identity(categoryFn));
  var gRouteNoArguments = new GRouteDuplexCtr(identity(categoryFn));
  ...
  var sum2 = function(dictGeneric) {
    return function(dictGRouteDuplex) {
      var $48 = dimap(profunctorRouteDuplex)(from(dictGeneric))(to(dictGeneric));
  ...
  var gRouteArgument = new GRouteDuplexCtr(identity(categoryFn));
  var gRouteAll = new GRouteDuplexCtr(function(v) {
    return new RouteDuplex(function(v1) {
      return v.value0(v1);
    }, map(functorRouteParser)(Argument)(v.value1));
  });

  // output/Routing.Duplex.Generic.Syntax/index.js
  var GSep = function(gsep2) {
    this.gsep = gsep2;
  };
  var gsepStringString = new GSep(function(a2) {
    return function(b2) {
      return prefix2(a2)(prefix2(b2)(pure(applicativeRouteDuplex)(unit)));
    };
  });
  var gsepStringRoute = function(dictGRouteDuplexCtr) {
    return new GSep(function(a2) {
      var $5 = prefix2(a2);
      var $6 = gRouteDuplexCtr(dictGRouteDuplexCtr);
      return function($7) {
        return $5($6($7));
      };
    });
  ...
  var genericRoute = new Generic(function(x) {
  ...
  var routeCodec = root(sum2(genericRoute)(gRouteSum(gRouteConstructor(new IsSymbol(function() {
    return "Home";
  }))()(gRouteNoArguments))(gRouteSum(gRouteConstructor(new IsSymbol(function() {
    return "Login";
  }))()(gRouteNoArguments))(gRouteConstructor(new IsSymbol(function() {
    return "Secrets";
  }))()(gRouteNoArguments))))({
    Home: noArgs,
  ...
  var showRoute = new Show(genericShow(genericRoute)(genericShowSum(genericShowConstructor(genericShowArgsNoArguments)(new IsSymbol(function() {
    return "Home";
  })))(genericShowSum(genericShowConstructor(genericShowArgsNoArguments)(new IsSymbol(function() {
    return "Login";
  })))(genericShowConstructor(genericShowArgsNoArguments)(new IsSymbol(function() {
    return "Secrets";
  }))))));
  var eqRoute = new Eq(function(x) {
    return function(y) {
  ...
  var ordRoute = new Ord(function() {
    ...
    return function(y) {
      ...
      ;
      throw new Error("Failed pattern match at App.Data.Route (line 22, column 1 - line 22, column 38): " + [x.constructor.name, y.constructor.name]);
    };
  });

  // output/App.Data.Username/index.js
  var eqUsername = new Eq(function(x) {
    return function(y) {
      return x === y;
    };
  });
  ...
  var updateLocalState = function(dictMonadState) {
    return function(v) {
      return bind(dictMonadState.Monad0().Bind1())(gets(dictMonadState)(function(v1) {
        ...
        return when(dictMonadState.Monad0().Applicative0())(notEq(eqMaybe(eqRec()(eqRowCons(eqRowNil)()(new IsSymbol(function() {
          return "username";
  ...
  var readInt = function(dictMonad) {
    return function(value13) {
      var error4 = Left.create(singleton4(new TypeMismatch("Int", tagOf(value13))));
    ...
    return function(f) {
      return function(ms) {
        return fold2(function(acc) {
          return function(k) {
            return function(v) {
              return apply(dictApplicative.Apply0())(map(dictApplicative.Apply0().Functor0())(flip(insert5(k)))(acc))(f(k)(v));
            };
          };
        })(pure(dictApplicative)(empty6))(ms);
      };
    };
  });
    ...
    return function(nat) {
      return function(v) {
        ...
        if (v instanceof ThunkSlot) {
          return ThunkSlot.create(hoist2(lmap(bifunctorHTML)(hoistSlot(dictFunctor)(nat)))(v.value0));
        }
        ;
  ...
  var functorComponentSlotBox = new Functor(function(f) {
    return unComponentSlot(function(slot2) {
      return mkComponentSlot({
        ...
        pop: slot2.pop,
        set: slot2.set,
        component: slot2.component,
        input: slot2.input,
        output: map(functorFn)(map(functorMaybe)(f))(slot2.output)
      });
    });
  });
  ...
  var newtypeHookAp = new Newtype(function() {
    return void 0;
  });
  var monadTransHookM = new MonadTrans(function(dictMonad) {
    return function($79) {
      return HookM(liftF(Lift3.create($79)));
    };
  });
  var monadHookM = freeMonad;
  var getRef2 = function(p2) {
    return HookM(liftF(new GetRef2(p2, identity(categoryFn))));
  };
  ...
  var monadRecHookM = new MonadRec(function() {
    return monadHookM;
  }, function(k) {
    return function(a2) {
      return bind(bindHookM)(k(a2))(function(v) {
        if (v instanceof Loop) {
          return tailRecM(monadRecHookM)(k)(v.value0);
        }
        ;
        if (v instanceof Done) {
          return pure(applicativeHookM)(v.value0);
        }
        ;
  ...
  var applicativeHookAp = applicativeFreeAp;
  var parallelHookM = new Parallel(function() {
    return applicativeHookAp;
  }, function() {
    return monadHookM;
  }, function($94) {
    return HookAp(liftFreeAp($94));
  }, function($95) {
    return HookM(liftF(Par2.create($95)));
  });

  // output/Halogen.Store.Monad/index.js
  var MonadStore = function(MonadEffect0, emitSelected2, getStore2, updateStore2) {
    this.MonadEffect0 = MonadEffect0;
    this.emitSelected = emitSelected2;
    this.getStore = getStore2;
    this.updateStore = updateStore2;
  };
  ...
  var monadStoreStoreT = function(dictMonadAff) {
        ...
        return liftEffect(monadEffectReader(dictMonadAff.MonadEffect0()))(function __do2() {
          ...
          return filterEmitter(store.emitter)(function($$new3) {
            return function __do3() {
              ...
              var $22 = v.eq(prevDerived)(newDerived);
              if ($22) {
                return Nothing.value;
              }
              ;
    ...
    }, bind(bindReaderT(dictMonadAff.MonadEffect0().Monad0().Bind1()))(ask(monadAskReaderT(dictMonadAff.MonadEffect0().Monad0())))(function(store) {
  ...
  var monadStoreHalogenM = function(dictMonadStore) {
    return new MonadStore(function() {
      ...
      var $23 = lift(monadTransHalogenM)(dictMonadStore.MonadEffect0().Monad0());
      var $24 = emitSelected(dictMonadStore);
      return function($25) {
        return $23($24($25));
      };
    }(), lift(monadTransHalogenM)(dictMonadStore.MonadEffect0().Monad0())(getStore(dictMonadStore)), function() {
  ...
  var Free2 = function(x) {
    return x;
  };
  var semiringFree = new Semiring(function(v) {
    return function(v1) {
  ...
  }, singleton3(Nil.value), Nil.value);
  var newtypeFree = new Newtype(function() {
    return void 0;
  });
  var functorFree = new Functor(function(fn) {
    return function(v) {
      return Free2(map(functorList)(map(functorList)(fn))(v));
    };
  });
  var free = function(a2) {
    return singleton3(singleton3(a2));
  };
  var foldableFree = new Foldable(function(dictMonoid) {
    return function(fn) {
      return function(v) {
        return fold(foldableList)(dictMonoid)(foldMap(foldableList)(monoidList)(map(functorList)(fn))(v));
      };
    };
  }, function(fn) {
    return function(accum) {
      return function(v) {
        return foldl(foldableList)(foldl(foldableList)(fn))(accum)(v);
      };
    };
  }, function(fn) {
    return function(accum) {
      return function(v) {
        return foldr(foldableList)(flip(foldr(foldableList)(fn)))(accum)(v);
      };
    };
  });
  var traversableFree = new Traversable(function() {
    return foldableFree;
  }, function() {
    return functorFree;
  }, function(dictApplicative) {
    return function(v) {
      return map(dictApplicative.Apply0().Functor0())(Free2)(sequence(traversableList)(dictApplicative)(map(functorList)(sequence(traversableList)(dictApplicative))(v)));
    };
  }, function(dictApplicative) {
    return function(fn) {
      return function(freeA) {
        return sequence(traversableFree)(dictApplicative)(map(functorFree)(fn)(freeA));
      };
    };
  });
  var applyFree = new Apply(function() {
    return functorFree;
  }, function(v) {
    return function(v1) {
      return Free2(bind(bindList)(v)(function(fns) {
        return bind(bindList)(v1)(function(xs) {
          return pure(applicativeList)(apply(applyList)(fns)(xs));
        });
      }));
    };
  });
  var applicativeFree = new Applicative(function() {
    return applyFree;
  }, free);

  // output/Data.String.NonEmpty.Internal/index.js
  var showNonEmptyString = new Show(function(v) {
    return "(NonEmptyString.unsafeFromString " + (show(showString)(v) + ")");
  });
  var showNonEmptyReplacement = new Show(function(v) {
    return "(NonEmptyReplacement " + (show(showNonEmptyString)(v) + ")");
  });
  ...
  var newtypeV = new Newtype(function() {
    return void 0;
  });
  ...
  var foldableV = new Foldable(function(dictMonoid) {
    return validation($$const(mempty(dictMonoid)));
  }, function(f) {
    return function(b2) {
      return validation($$const(b2))(f(b2));
    };
  }, function(f) {
    return function(b2) {
      return validation($$const(b2))(flip(f)(b2));
    };
  });
  var traversableV = new Traversable(function() {
    return foldableV;
  }, function() {
    return functorV;
  }, function(dictApplicative) {
    return validation(function() {
      ...
      return function($71) {
        return $70(V(Left.create($71)));
      };
    }())(map(dictApplicative.Apply0().Functor0())(function($72) {
      return V(Right.create($72));
    }));
  }, function(dictApplicative) {
    return function(f) {
      return validation(function() {
        var $73 = pure(dictApplicative);
        return function($74) {
          return $73(V(Left.create($74)));
        };
      }())(function() {
        var $75 = map(dictApplicative.Apply0().Functor0())(function($77) {
          return V(Right.create($77));
        });
        return function($76) {
          return $75(f($76));
        };
    ...
    return new Apply(function() {
      ...
      return function(v1) {
        if (v instanceof Left && v1 instanceof Left) {
          return new Left(mul(dictSemiring)(v.value0)(v1.value0));
        }
        ;
        if (v instanceof Left) {
          return new Left(v.value0);
  ...
  var altV = function(dictSemiring) {
    return new Alt(function() {
      ...
      return function(v1) {
        if (v instanceof Left && v1 instanceof Left) {
          return new Left(add(dictSemiring)(v.value0)(v1.value0));
        }
        ;
        if (v instanceof Left) {
          return v1;
  ...
  var eqRoutePart = new Eq(function(x) {
    return function(y) {
      if (x instanceof Path && y instanceof Path) {
        return x.value0 === y.value0;
      }
      ;
      if (x instanceof Query2 && y instanceof Query2) {
        return eq(eqMap(eqString)(eqString))(x.value0)(y.value0);
      }
      ;
      return false;
    };
  });
  var ordRoutePart = new Ord(function() {
    return eqRoutePart;
  }, function(x) {
    return function(y) {
      if (x instanceof Path && y instanceof Path) {
      ...
      ;
      if (x instanceof Query2 && y instanceof Query2) {
        return compare(ordMap(ordString)(ordString))(x.value0)(y.value0);
      }
      ;
  ...
  var str = function(route) {
    if (route instanceof Cons && route.value0 instanceof Path) {
      return pure(applicativeV(semiringFree))(new Tuple(route.value1, route.value0.value0));
    }
    ;
  ...
  var runMatch = function(v) {
    return function(route) {
      var foldErrors = function(errs) {
        return Left.create(foldl(foldableList)(function(b2) {
          return function(a2) {
            return a2 + ("\n" + b2);
          };
  ...
  var newtypeMatch = new Newtype(function() {
    return void 0;
  });
  var matchFunctor = new Functor(function(fn) {
    return function(v) {
      return Match(function(r) {
        return validation(invalid)(function(v1) {
          return pure(applicativeV(semiringFree))(new Tuple(v1.value0, fn(v1.value1)));
        })(v(r));
      });
    };
  });
  var matchApply = new Apply(function() {
    return matchFunctor;
  }, function(v) {
    return function(v1) {
      var processFnRes = function(v2) {
        return validation(invalid)(function(v3) {
          return pure(applicativeV(semiringFree))(new Tuple(v3.value0, v2.value1(v3.value1)));
        })(v1(v2.value0));
      };
      var processFnErr = function(r) {
        return function(err) {
          return invalid(mul(semiringFree)(err)(validation(identity(categoryFn))($$const(one(semiringFree)))(v1(r))));
        };
      };
      return Match(function(r) {
  ...
  var matchApplicative = new Applicative(function() {
    return matchApply;
  }, function(a2) {
    return function(r) {
      return pure(applicativeV(semiringFree))(new Tuple(r, a2));
    };
  });
  var matchAlt = new Alt(function() {
    return matchFunctor;
  }, function(v) {
    return function(v1) {
      return Match(function(r) {
  ...
  var matchPlus = new Plus(function() {
    return matchAlt;
  }, Match($$const(invalid(one(semiringFree)))));
  var matchAlternative = new Alternative(function() {
  ...
  var lit = function(input3) {
    return function(route) {
      if (route instanceof Cons && (route.value0 instanceof Path && route.value0.value0 === input3)) {
        return pure(applicativeV(semiringFree))(new Tuple(route.value1, unit));
      }
      ;
      if (route instanceof Cons && route.value0 instanceof Path) {
  ...
  var eitherMatch = function(v) {
    var runEither = function(v1) {
      if (v1.value1 instanceof Left) {
        return invalid(free(new Fail2("Nested check failed")));
      }
      ;
      if (v1.value1 instanceof Right) {
        return pure(applicativeV(semiringFree))(new Tuple(v1.value0, v1.value1.value0));
      }
      ;
  ...
  var nonempty = eitherMatch(map(matchFunctor)(function() {
    var $93 = maybe(new Left("Empty string"))(Right.create);
    return function($94) {
  ...
  var BoundedEnum = function(Bounded0, Enum1, cardinality, fromEnum2, toEnum2) {
    this.Bounded0 = Bounded0;
    this.Enum1 = Enum1;
    this.cardinality = cardinality;
    this.fromEnum = fromEnum2;
    this.toEnum = toEnum2;
  };
    ...
    return function(low2) {
      return function(high2) {
        return function(x) {
          ...
          ;
          if (v instanceof Nothing) {
            var $51 = x < fromEnum(dictBoundedEnum)(bottom(dictBoundedEnum.Bounded0()));
            if ($51) {
              return low2;
            }
            ;
  ...
  var showCodePoint = new Show(function(v) {
  ...
  var parse3 = function(decoder) {
    return function(hash3) {
      ...
      var v = map(functorMaybe)(flip(splitAt3)(hash3))(indexOf2("?")(hash3));
      if (v instanceof Just) {
  ...
  var hash2 = function(location2) {
    return function() {
      return location2.hash;
    };
  };
  var setHash = function(hash3) {
  ...
  var monadLogAppM = new MonadLog(function() {
    return monadAppM;
  }, function(msg) {
    return updateStore(monadStoreAppM)(new UpdateMessageLog(msg));
  });
  var monadAffAppM = monadAffStoreT(monadAffAff);
  var functorAppM = functorStoreT(functorAff);
  var bindAppM = bindStoreT(bindAff);
  var monadNavigateAppM = new MonadNavigate(function() {
    return monadAppM;
  }, discard(discardUnit)(bindAppM)(updateStore(monadStoreAppM)(LogoutUser.value))(function() {
  ...
  var monadUserAppM = new MonadUser(function() {
    return monadAppM;
  }, function(username) {
    var profile = {
      username
    };
    return discard(discardUnit)(bindAppM)(updateStore(monadStoreAppM)(new LoginUser(profile)))(function() {
      return pure(applicativeAppM)(new Just(profile));
    });
  });
      ...
      return function(dictOrd) {
        return function(label5) {
          return function(p2) {
            return function(component5) {
              return function(input3) {
                return widget(new ComponentSlot(componentSlot()(dictIsSymbol)(dictOrd)(label5)(p2)(component5)(input3)($$const(Nothing.value))));
              };
            };
          };
        };
            ...
            return function(component5) {
              return function(input3) {
                return function(outputQuery) {
                  return widget(new ComponentSlot(componentSlot()(dictIsSymbol)(dictOrd)(label5)(p2)(component5)(input3)(function($6) {
        ...
        return function(component5) {
          var renderInner = function(input3) {
            return function(context) {
              return slot()(new IsSymbol(function() {
                return "inner";
          ...
          return mkComponent({
            ...
            "eval": mkEval({
              handleAction,
              handleQuery: query()(new IsSymbol(function() {
                return "inner";
  ...
  var component = function(dictMonadEffect) {
    return function(dictMonadStore) {
      ...
      return connect(dictMonadEffect)(dictMonadStore)(selectEq(eqMaybe(eqRec()(eqRowCons(eqRowNil)()(new IsSymbol(function() {
        return "username";
    ...
    return function(dictMonadLog) {
      return function(dictMonadNavigate) {
        return function(dictMonadUser) {
          ...
          return connect(dictMonadStore.MonadEffect0())(dictMonadStore)(selectEq(eqMaybe(eqRec()(eqRowCons(eqRowNil)()(new IsSymbol(function() {
            return "username";
          }))(eqUsername))))(function(v) {
            return v.currentUser;
          }))(mkComponent({
            ...
            var render = function(v) {
              var authorize = function(mbProfile) {
                return function(html2) {
                  if (mbProfile instanceof Nothing) {
                    return slot_()(new IsSymbol(function() {
                      return "login";
              ...
              return navbarPageWrapper(v)(function() {
                ...
                if (v.route instanceof Just && v.route.value0 instanceof Secrets) {
                  return authorize(v.currentUser)(slot_()(new IsSymbol(function() {
                    return "secrets";
            ...
            var handleQuery = function() {
              ...
              return function(v) {
                return bind(bindHalogenM)(gets(monadStateHalogenM)(function(v1) {
                  ...
                  return discard(discardUnit)(bindHalogenM)(when(applicativeHalogenM)(notEq(eqMaybe(eqRoute))(maybeOldRoute)(new Just(v.value0)))(discard(discardUnit)(bindHalogenM)(modify_2(monadStateHalogenM)(function(v1) {
                    var $33 = {};
                    for (var $34 in v1) {
  ...
  var evalQ = function(render) {
    return function(ref3) {
      return function(q2) {
        return bind(bindAff)(liftEffect(monadEffectAff)(read(ref3)))(function(v) {
          return evalM(render)(ref3)(v["component"]["eval"](new Query(map(functorCoyoneda)(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
      ...
      return bind(bindAff)(runUI2(componentAff)(unit)(body3))(function(halogenIO) {
        return $$void(functorAff)(liftEffect(monadEffectAff)(matchesWith(foldableEither)(parse(routeCodec))(function(mOld) {
          return function($$new3) {
            return when(applicativeEffect)(notEq(eqMaybe(eqRoute))(mOld)(new Just($$new3)))(launchAff_(halogenIO.query(mkTell(Navigate.create($$new3)))));
          };
        })));
      });
    });
