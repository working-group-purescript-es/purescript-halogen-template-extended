...
(function($PS) {
    ...
    var substFree = function(k) {
        var go = function(f) {
            var v = toView(f);
            if (v instanceof Return1) return Control_Applicative.pure(freeApplicative)(v.value0);
            if (v instanceof Bind1) return Control_Bind.bind(freeBind)(k(v.value0))(Data_Functor.map(Data_Functor.functorFn)(go)(v.value1));
...
(function($PS) {
    ...
    var mkOrdBox = function(dictOrd) {
        return OrdBox1.create(Data_Eq.eq(dictOrd.Eq0()))(Data_Ord.compare(dictOrd));
    };
    var eqOrdBox = {
        eq: function(v) {
            return function(v1) {
...
(function($PS) {
    ...
    var subscribe = function(es) {
        return HalogenM(Control_Monad_Free.liftF(new Subscribe1(function(v) {
            return es;
        }, Control_Category.identity(Control_Category.categoryFn))));
    };
    var raise = function(o) {
        return HalogenM(Control_Monad_Free.liftF(new Raise1(o, Data_Unit.unit)));
    };
        ...
        return function(dictIsSymbol) {
            return function(dictOrd) {
                return function(label) {
                    return function(p) {
                        return function(q) {
                            return HalogenM(Control_Monad_Free.liftF(ChildQuery2.create(Halogen_Query_ChildQuery.mkChildQueryBox(new Halogen_Query_ChildQuery.ChildQuery(function(dictApplicative) {
                                return function(k) {
    ...
    var monadTransHalogenM = {
        lift: function(dictMonad) {
            return function($135) {
                return HalogenM(Control_Monad_Free.liftF(Lift2.create($135)));
            };
        }
    };
    ...
    var hoist = function(dictFunctor) {
        return function(nat) {
            return function(v) {
                var go = function(v1) {
                    if (v1 instanceof State1) return new State1(v1.value0);
                    if (v1 instanceof Subscribe1) return new Subscribe1(v1.value0, v1.value1);
                    if (v1 instanceof Unsubscribe1) return new Unsubscribe1(v1.value0, v1.value1);
                    if (v1 instanceof Lift2) return new Lift2(nat(v1.value0));
                    if (v1 instanceof ChildQuery2) return new ChildQuery2(v1.value0);
                    if (v1 instanceof Raise1) return new Raise1(v1.value0, v1.value1);
                    if (v1 instanceof Par1) return new Par1(Data_Newtype.over()()(HalogenAp)(Control_Applicative_Free.hoistFreeAp(hoist(dictFunctor)(nat)))(v1.value0));
                    if (v1 instanceof Fork1) return new Fork1(hoist(dictFunctor)(nat)(v1.value0), v1.value1);
                    if (v1 instanceof Kill1) return new Kill1(v1.value0, v1.value1);
                    if (v1 instanceof GetRef1) return new GetRef1(v1.value0, v1.value1);
    ...
    exports["Lift"] = Lift2;
    exports["ChildQuery"] = ChildQuery2;
...
(function($PS) {
    ...
    var fromArray = function(xs) {
        ...
        throw new Error("Failed pattern match at Data.Array.NonEmpty (line 159, column 1 - line 159, column 58): " + [
            xs.constructor.name
        ]);
    };
...
(function($PS) {
    ...
    var ExpectedEndOfPath1 = function() {
    ...
    var take = new Chomp1(function(state) {
        var v = Data_Array.uncons(state.segments);
        if (v instanceof Data_Maybe.Just) return new Success1({
            segments: v.value0.tail,
            params: state.params,
            hash: state.hash
        }, v.value0.head);
        return new Fail1(EndOfPath1.value);
    });
    var prefix = Prefix1.create;
        ...
        var splitAt = function(k) {
            return function(p) {
                return function(str) {
                    ...
                    if (v instanceof Data_Maybe.Just) return new Data_Tuple.Tuple(Data_String_CodeUnits.take(v.value0)(str), Data_String_CodeUnits.drop(v.value0 + Data_String_CodeUnits.length(p) | 0)(str));
                    if (v instanceof Data_Maybe.Nothing) return k(str);
                    throw new Error("Failed pattern match at Routing.Duplex.Parser (line 185, column 5 - line 187, column 23): " + [
                        v.constructor.name
                    ]);
                };
            };
    ...
    var hash = new Chomp1(function(state) {
        return new Success1(state, state.hash);
    });
    var functorRouteResult = {
        map: function(f) {
            return function(m) {
                if (m instanceof Fail1) return new Fail1(m.value0);
                if (m instanceof Success1) return new Success1(m.value0, f(m.value1));
                throw new Error("Failed pattern match at Routing.Duplex.Parser (line 53, column 1 - line 53, column 58): " + [
                    m.constructor.name
                ]);
            };
        }
    ...
    var functorRouteParser = {
        map: function(f) {
            return function(m) {
                if (m instanceof Alt1) return new Alt1(Data_Functor.map(Data_Array_NonEmpty_Internal.functorNonEmptyArray)(Data_Functor.map(functorRouteParser)(f))(m.value0));
                if (m instanceof Chomp1) return new Chomp1(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(functorRouteResult)(f))(m.value0));
                if (m instanceof Prefix1) return new Prefix1(m.value0, Data_Functor.map(functorRouteParser)(f)(m.value1));
                throw new Error("Failed pattern match at Routing.Duplex.Parser (line 72, column 1 - line 72, column 58): " + [
                    m.constructor.name
                ]);
            };
        }
    };
    var end = new Chomp1(function(state) {
        var v = Data_Array.head(state.segments);
        if (v instanceof Data_Maybe.Nothing) return new Success1(state, Data_Unit.unit);
        if (v instanceof Data_Maybe.Just) return new Fail1(new ExpectedEndOfPath1(v.value0));
        throw new Error("Failed pattern match at Routing.Duplex.Parser (line 256, column 3 - line 258, column 45): " + [
            v.constructor.name
        ]);
    });
    var chompPrefix = function(pre) {
        return function(state) {
            var v = Data_Array.head(state.segments);
            if (v instanceof Data_Maybe.Just && pre === v.value0) return new Success1({
                segments: Data_Array.drop(1)(state.segments),
                params: state.params,
                hash: state.hash
            }, Data_Unit.unit);
            if (v instanceof Data_Maybe.Just) return Fail1.create(new Expected1(pre, v.value0));
            return Fail1.create(EndOfPath1.value);
        };
    };
    var runRouteParser = function() {
        var goAlt = function(v) {
            return function(v1) {
                return function(v2) {
                    if (v1 instanceof Fail1) return runRouteParser(v)(v2);
                    return v1;
                };
            };
        };
        var go = function($copy_state) {
            return function($copy_v) {
                ...
                function $tco_loop(state, v) {
                    if (v instanceof Alt1) {
                        $tco_done = true;
                        return Data_Foldable.foldl(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(goAlt(state))(new Fail1(EndOfPath1.value))(v.value0);
                    }
                    if (v instanceof Chomp1) {
                        $tco_done = true;
                        return v.value0(state);
                    }
                    if (v instanceof Prefix1) {
                        var v1 = chompPrefix(v.value0)(state);
                        if (v1 instanceof Fail1) {
                            $tco_done = true;
                            return new Fail1(v1.value0);
                        }
                        if (v1 instanceof Success1) {
                            $tco_var_state = v1.value0;
                            $copy_v = v.value1;
                            return;
                        }
                        throw new Error("Failed pattern match at Routing.Duplex.Parser (line 149, column 7 - line 151, column 40): " + [
                            v1.constructor.name
                        ]);
                    }
                    throw new Error("Failed pattern match at Routing.Duplex.Parser (line 145, column 14 - line 151, column 40): " + [
                        v.constructor.name
                    ]);
                }
                while(!$tco_done)$tco_result = $tco_loop($tco_var_state, $copy_v);
                return $tco_result;
            };
        };
        return go;
    ...
    var run = function(p) {
        ...
        return function($255) {
            return (function(v) {
                if (v instanceof Fail1) return new Data_Either.Left(v.value0);
                if (v instanceof Success1) return new Data_Either.Right(v.value1);
                throw new Error("Failed pattern match at Routing.Duplex.Parser (line 190, column 49 - line 192, column 29): " + [
                    v.constructor.name
                ]);
            })($254(parsePath($255)));
        };
    ...
    var applyRouteParser = {
        apply: function(fx) {
            return function(x) {
                return new Chomp1(function(state) {
                    var v = runRouteParser(state)(fx);
                    if (v instanceof Fail1) return new Fail1(v.value0);
                    if (v instanceof Success1) return Data_Functor.map(functorRouteResult)(v.value1)(runRouteParser(v.value0)(x));
                    throw new Error("Failed pattern match at Routing.Duplex.Parser (line 76, column 5 - line 78, column 56): " + [
                        v.constructor.name
                    ]);
                });
            };
    ...
    var applicativeRouteParser = {
        pure: function() {
            var $256 = Data_Function.flip(Success1.create);
            return function($257) {
                return Chomp1.create($256($257));
            };
        }(),
        Apply0: function() {
    ...
    var altSnoc = function(ls) {
        return function(v) {
            ...
            if (v instanceof Prefix1) {
                ...
                if ($197 instanceof Prefix1) {
                    var $198 = v.value0 === $197.value0;
                    if ($198) return Data_Array_NonEmpty["snoc'"](Data_Array_NonEmpty.init(ls))(new Prefix1(v.value0, Control_Alt.alt(altRouteParser)($197.value1)(v.value1)));
                    return v1(true);
                }
                return v1(true);
            }
    ...
    var altRouteParser = {
        alt: function(v) {
            return function(v1) {
                if (v instanceof Alt1 && v1 instanceof Alt1) return new Alt1(altAppend(v.value0)(v1.value0));
                if (v instanceof Alt1) return new Alt1(altSnoc(v.value0)(v1));
                if (v1 instanceof Alt1) return new Alt1(altCons(v)(v1.value0));
                if (v instanceof Prefix1 && v1 instanceof Prefix1 && v.value0 === v1.value0) return new Prefix1(v.value0, Control_Alt.alt(altRouteParser)(v.value1)(v1.value1));
                return new Alt1(Data_Array_NonEmpty.cons(v)(Data_Array_NonEmpty.singleton(v1)));
            };
        },
        Functor0: function() {
            return functorRouteParser;
    ...
    var altCons = function(v) {
        return function(rs) {
            ...
            if (v instanceof Prefix1) {
                ...
                if ($217 instanceof Prefix1) {
                    var $218 = v.value0 === $217.value0;
                    if ($218) return Data_Array_NonEmpty["cons'"](new Prefix1(v.value0, Control_Alt.alt(altRouteParser)(v.value1)($217.value1)))(Data_Array_NonEmpty.tail(rs));
                    return v1(true);
                }
                return v1(true);
            }
    ...
    var altAppend = function($copy_ls) {
        return function($copy_rs) {
            ...
            function $tco_loop(ls, rs) {
                var v = function(v1) {
                    if (Data_Boolean.otherwise) return Data_Semigroup.append(Data_Array_NonEmpty_Internal.semigroupNonEmptyArray)(ls)(rs);
                    throw new Error("Failed pattern match at Routing.Duplex.Parser (line 98, column 1 - line 101, column 32): " + [
                        ls.constructor.name,
                        rs.constructor.name
                    ]);
                };
                var $227 = Data_Array_NonEmpty.last(ls);
                if ($227 instanceof Prefix1) {
                    var $228 = Data_Array_NonEmpty.head(rs);
                    if ($228 instanceof Prefix1) {
                        var $229 = $227.value0 === $228.value0;
                        if ($229) {
                            var rs$prime = Data_Array_NonEmpty["cons'"](new Prefix1($227.value0, Control_Alt.alt(altRouteParser)($227.value1)($228.value1)))(Data_Array_NonEmpty.tail(rs));
                            ...
                            throw new Error("Failed pattern match at Routing.Duplex.Parser (line 110, column 9 - line 112, column 26): " + [
                                v1.constructor.name
                            ]);
                        }
                        $tco_done = true;
            ...
            while(!$tco_done)$tco_result = $tco_loop($tco_var_ls, $copy_rs);
            return $tco_result;
        };
    };
    exports["run"] = run;
...
(function($PS) {
    ...
    var printPath = function(v) {
        ...
        var printParam = function(key) {
            return function(v1) {
                if (v1 === "") return unsafeEncodeURIComponent(key);
...
(function($PS) {
    ...
    var profunctorRouteDuplex = {
        dimap: function(f) {
            return function(g) {
                return function(v) {
                    return new RouteDuplex1(function($103) {
    ...
    var prefix = function(s) {
        return function(v) {
            return new RouteDuplex1(function(a) {
    ...
    var functorRouteDuplex = {
        map: function(f) {
            return function(m) {
                return new RouteDuplex1(m.value0, Data_Functor.map(Routing_Duplex_Parser.functorRouteParser)(f)(m.value1));
            };
        }
    };
    var end = function(v) {
        return new RouteDuplex1(v.value0, Control_Apply.applyFirst(Routing_Duplex_Parser.applyRouteParser)(v.value1)(Routing_Duplex_Parser.end));
    };
    var applyRouteDuplex = {
        apply: function(v) {
            return function(v1) {
                return new RouteDuplex1(Control_Apply.apply(Control_Apply.applyFn)(Data_Functor.map(Data_Functor.functorFn)(Data_Semigroup.append(Routing_Duplex_Printer.semigroupRoutePrinter))(v.value0))(v1.value0), Control_Apply.apply(Routing_Duplex_Parser.applyRouteParser)(v.value1)(v1.value1));
            };
        },
        Functor0: function() {
    ...
    var applicativeRouteDuplex = {
        pure: function() {
            var $109 = RouteDuplex1.create(Data_Function["const"](Data_Monoid.mempty(Routing_Duplex_Printer.monoidRoutePRinter)));
    ...
    exports["RouteDuplex"] = RouteDuplex1;
    exports["parse"] = parse;
    exports["print"] = print;
    exports["prefix"] = prefix;
    exports["root"] = root;
        ...
        return function(dictGRouteDuplex1) {
            return {
                gRouteDuplex: function(r) {
                    ...
                    var enc = function(v2) {
                        if (v2 instanceof Data_Generic_Rep.Inl) return v.value0(v2.value0);
                        if (v2 instanceof Data_Generic_Rep.Inr) return v1.value0(v2.value0);
                        throw new Error("Failed pattern match at Routing.Duplex.Generic (line 33, column 11 - line 35, column 22): " + [
                            v2.constructor.name
                        ]);
                    };
...
(function($PS) {
    ...
    var genericRoute = {
        to: function(x) {
            if (x instanceof Data_Generic_Rep.Inl) return Home1.value;
            if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) return Login1.value;
            if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inr) return Secrets1.value;
            throw new Error("Failed pattern match at App.Data.Route (line 20, column 1 - line 20, column 48): " + [
                x.constructor.name
            ]);
        },
        from: function(x) {
            if (x instanceof Home1) return new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value);
            if (x instanceof Login1) return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value));
            if (x instanceof Secrets1) return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(Data_Generic_Rep.NoArguments.value));
            throw new Error("Failed pattern match at App.Data.Route (line 20, column 1 - line 20, column 48): " + [
                x.constructor.name
            ]);
        }
    ...
    var eqRoute = {
        eq: function(x) {
            return function(y) {
                if (x instanceof Home1 && y instanceof Home1) return true;
                if (x instanceof Login1 && y instanceof Login1) return true;
                if (x instanceof Secrets1 && y instanceof Secrets1) return true;
                return false;
            };
        }
    };
...
(function($PS) {
    ...
    var LogoutUser1 = function() {
        function LogoutUser() {
        }
        LogoutUser.value = new LogoutUser();
        return LogoutUser;
    }();
    var UpdateMessageLog1 = function() {
        ...
        return function(v) {
            return Control_Bind.bind(dictMonadState.Monad0().Bind1())(Control_Monad_State_Class.gets(dictMonadState)(function(v1) {
                ...
                return Control_Applicative.when(dictMonadState.Monad0().Applicative0())(Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()({
                    ...
                    for(var $10 in v1)if (({
                    }).hasOwnProperty.call(v1, $10)) $9[$10] = v1[$10];
    ...
    var reduce = function(store) {
        return function(v) {
            if (v instanceof LoginUser1) return {
                currentUser: new Data_Maybe.Just(v.value0),
                recentMessageLog: store.recentMessageLog
            };
            if (v instanceof LogoutUser1) return {
                currentUser: Data_Maybe.Nothing.value,
                recentMessageLog: store.recentMessageLog
            };
            if (v instanceof UpdateMessageLog1) {
                var prependMessage = function(x) {
                    return function(xs) {
                        if (Data_Array.length(xs) < 10) return Data_Array.cons(x)(xs);
                        if (Data_Boolean.otherwise) return Data_Array.cons(x)(Data_Array.take(9)(xs));
                        throw new Error("Failed pattern match at App.Store (line 35, column 7 - line 35, column 63): " + [
                            x.constructor.name,
                            xs.constructor.name
                        ]);
                    };
            ...
            throw new Error("Failed pattern match at App.Store (line 25, column 16 - line 40, column 79): " + [
                v.constructor.name
            ]);
        };
    };
    exports["LoginUser"] = LoginUser1;
    exports["LogoutUser"] = LogoutUser1;
    exports["UpdateMessageLog"] = UpdateMessageLog1;
...
(function($PS) {
    ...
    var functorInput = {
        map: function(f) {
            return function(m) {
                if (m instanceof RefUpdate1) return new RefUpdate1(m.value0, m.value1);
                if (m instanceof Action1) return new Action1(f(m.value0));
...
(function($PS) {
    ...
    var functorProp = {
        map: function(v) {
            return function(v1) {
                if (v1 instanceof Handler1) return new Handler1(v1.value0, Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Maybe.functorMaybe)(v))(v1.value1));
                if (v1 instanceof Ref1) return new Ref1(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Maybe.functorMaybe)(v))(v1.value0));
                return v1;
            };
        }
    };
        ...
        bimap: function(v) {
            return function(v1) {
                return function(v2) {
                    ...
                    if (v2 instanceof Grafted1) return new Grafted1(Data_Bifunctor.bimap(bifunctorGraft)(v)(v1)(v2.value0));
                    return new Grafted1(graft(new Graft1(v, v1, v2)));
                };
            };
        }
    };
...
(function($PS) {
    ...
    var mapThunk = function(k) {
        return function(v) {
            return new Thunk1(v.value0, v.value1, function($46) {
...
(function($PS) {
    ...
    var hoistSlot = function(dictFunctor) {
        return function(nat) {
            return function(v) {
                if (v instanceof ComponentSlot1) return unComponentSlot(function(slot) {
                    return ComponentSlot1.create(mkComponentSlot({
                        get: slot.get,
                        pop: slot.pop,
                        set: slot.set,
                ...
                if (v instanceof ThunkSlot1) return ThunkSlot1.create(Halogen_VDom_Thunk.hoist(Data_Bifunctor.lmap(Halogen_HTML_Core.bifunctorHTML)(hoistSlot(dictFunctor)(nat)))(v.value0));
                    ...
                    return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(dictMonadAff.MonadEffect0()))(function __do() {
                        ...
                        return filterEmitter(store.emitter)(function($$new) {
                            return function __do() {
                                ...
                                if ($23) return Data_Maybe.Nothing.value;
...
(function($PS) {
    ...
    var whenElem = function(cond) {
        return function(f) {
            if (cond) return f(Data_Unit.unit);
    ...
    var navItem = function(route) {
        return function(label) {
            return Halogen_HTML_Elements.li_([
                Halogen_HTML_Elements.a([
                    safeHref(route)
                ])([
    ...
    var maybeElem = function(v) {
        return function(v1) {
            if (v instanceof Data_Maybe.Just) return v1(v.value0);
            return Halogen_HTML_Core.text("");
        };
    };
...
(function($PS) {
    ...
    var navbarPageWrapper = function(v) {
        return function(innerHtml) {
            var navbar = Halogen_HTML_Elements.ul_([
                App_Component_HTML_Util.navItem(App_Data_Route.Home.value)("Home"),
                App_Component_HTML_Util.whenElem(Data_Maybe.isNothing(v.currentUser))(function(v1) {
            ...
            var fakeConsole = function(messages) {
                return Halogen_HTML_Elements.div([
                    Halogen_HTML_Properties.style(consoleStyle)
                ])([
                    Halogen_HTML_Elements.h2([
                        Halogen_HTML_Properties.style("font-variant: small-caps;")
                    ])([
                        Halogen_HTML_Core.text("Fake Console: ")
                    ]),
                    Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(function(msg) {
                        return Halogen_HTML_Elements.li_([
                            Halogen_HTML_Core.text(msg)
                        ]);
                    })(messages))
                ]);
            };
            return Halogen_HTML_Elements.div([
                Halogen_HTML_Properties.style(wrapperStyle)
            ])([
                ...
                Halogen_HTML_Elements.div_([
                    Halogen_HTML_Elements.hr_,
                    fakeConsole(v.messageLog)
                ])
            ]);
        };
    };
            ...
            return function(v) {
                return function(component) {
                    ...
                    var render = function(state) {
                        if (state.context instanceof Data_Maybe.Just) return renderInner(state.input)(state.context.value0);
                        return Halogen_HTML_Core.text("");
                    };
                    ...
                    var handleAction = function(v1) {
                        if (v1 instanceof Initialize2) return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(subscribe(dictMonadStore)(v)(Update1.create))(function() {
                            return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(v.select)(Halogen_Store_Monad.getStore(Halogen_Store_Monad.monadStoreHalogenM(dictMonadStore))))(function(context) {
                                return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function(v2) {
                                    ...
                                    for(var $17 in v2)if (({
                                    }).hasOwnProperty.call(v2, $17)) $16[$17] = v2[$17];
                                    $16.context = new Data_Maybe.Just(context);
                                    return $16;
                                });
                            });
                        });
                        if (v1 instanceof Receive2) return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function(v2) {
                            return v2.input;
                        }))(function(oldInput) {
                            return Control_Applicative.unless(Halogen_Query_HalogenM.applicativeHalogenM)(Unsafe_Reference.unsafeRefEq(oldInput)(v1.value0))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function(v2) {
                                ...
                                for(var $20 in v2)if (({
                                }).hasOwnProperty.call(v2, $20)) $19[$20] = v2[$20];
                                $19.input = v1.value0;
                                return $19;
                            }));
                        });
                        if (v1 instanceof Update1) return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function(v2) {
                            return v2.context;
                        }))(function(v2) {
                            if (v2 instanceof Data_Maybe.Just && Unsafe_Reference.unsafeRefEq(v2.value0)(v1.value0)) return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                            return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function(v3) {
                                var $25 = {
                                };
                                for(var $26 in v3)if (({
                                }).hasOwnProperty.call(v3, $26)) $25[$26] = v3[$26];
                                $25.context = new Data_Maybe.Just(v1.value0);
                                return $25;
                            });
                        });
                        if (v1 instanceof Raise2) return Halogen_Query_HalogenM.raise(v1.value0);
                    ...
                    return Halogen_Component.mkComponent({
                        ...
                        "eval": Halogen_Component.mkEval({
                            ...
                            initialize: new Data_Maybe.Just(Initialize2.value),
                            finalize: Data_Maybe.Nothing.value,
                            receive: function($30) {
                                return Data_Maybe.Just.create(Receive2.create($30));
                            }
                        })
                    });
                };
        ...
        return function(dictMonadStore) {
            var render = function(v) {
                var message = function() {
                    if (v.currentUser instanceof Data_Maybe.Nothing) return "Welcome, guest. Perhaps consider logging in?";
                    if (v.currentUser instanceof Data_Maybe.Just) return "WELCOME HOME, " + (App_Data_Username.toString(v.currentUser.value0.username) + "!! Your secrets page is now available.");
                    throw new Error("Failed pattern match at App.Page.Home (line 58, column 17 - line 62, column 109): " + [
                        v.currentUser.constructor.name
                    ]);
                }();
                return Halogen_HTML_Elements.div_([
                    Halogen_HTML_Elements.h1_([
                        Halogen_HTML_Core.text("Home page")
                    ]),
            ...
            var $$eval = Halogen_Component.mkEval({
                ...
                receive: function($15) {
                    return Data_Maybe.Just.create(Receive3.create($15));
                },
            ...
            return function(dictMonadNavigate) {
                return function(dictMonadUser) {
                    var render = function(v) {
                        return Halogen_HTML_Elements.div_([
                            Halogen_HTML_Elements.h1_([
                                Halogen_HTML_Core.text("Sign in")
                            ]),
                            Halogen_HTML_Elements.p_([
                                Halogen_HTML_Core.text("Please only click the button below if you are actually 'bloodninja'")
                            ]),
                            Halogen_HTML_Elements.button([
                                Halogen_HTML_Events.onClick(function(mouseEvent) {
                                    return new HandleLogin1(mouseEvent, "bloodninja");
                                })
                            ])([
                    ...
                    var handleAction = function(v) {
                        return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Web_Event_Event.preventDefault(Web_UIEvent_MouseEvent.toEvent(v.value0))))(function() {
                            ...
                            if (v1 instanceof Data_Maybe.Nothing) return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                            if (v1 instanceof Data_Maybe.Just) return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(App_Capability_Resource_User.loginUser(App_Capability_Resource_User.monadUserHalogenM(dictMonadUser))(v1.value0))(function() {
                            ...
                            throw new Error("Failed pattern match at App.Page.Login (line 72, column 9 - line 79, column 37): " + [
                                v1.constructor.name
                            ]);
                        });
                    };
                ...
                return function(dictMonadUser) {
                    var render = function(v) {
                        return App_Component_HTML_Util.maybeElem(v.currentUser)(function(profile) {
                            ...
                            return Halogen_HTML_Elements.div_([
                                Halogen_HTML_Elements.h1_([
                                    Halogen_HTML_Core.text(name + "'s page of secrets")
                                ]),
                                Halogen_HTML_Elements.p_([
                                    Halogen_HTML_Core.text("Hello, " + (name + ".\x0a"))
                                ]),
                                Halogen_HTML_Elements.p_([
                                    Halogen_HTML_Core.text("Your Secret: `traverse`")
                                ]),
                                Halogen_HTML_Elements.button([
                                    Halogen_HTML_Events.onClick(function(mouseEvent) {
                                        return new HandleLogout1(mouseEvent);
                                    })
                                ])([
                    ...
                    var handleAction = function(v) {
                        if (v instanceof Initialize3) return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function(v1) {
                            return v1.currentUser;
                        }))(function(v1) {
                            if (v1 instanceof Data_Maybe.Nothing) return App_Capability_Navigate.logoutUser(App_Capability_Navigate.monadNavigateHalogenM(dictMonadNavigate));
                            if (v1 instanceof Data_Maybe.Just) return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                            throw new Error("Failed pattern match at App.Page.Secrets (line 84, column 34 - line 89, column 31): " + [
                                v1.constructor.name
                            ]);
                        });
                        if (v instanceof Receive4) return App_Store.updateLocalState(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0);
                        if (v instanceof HandleLogout1) return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadStore.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_MouseEvent.toEvent(v.value0))))(function() {
                        ...
                        throw new Error("Failed pattern match at App.Page.Secrets (line 82, column 20 - line 97, column 28): " + [
                            v.constructor.name
                        ]);
                    };
                    var $$eval = Halogen_Component.mkEval({
                        ...
                        handleQuery: Halogen_Component.defaultEval.handleQuery,
                        receive: function($20) {
                            return Data_Maybe.Just.create(Receive4.create($20));
                        },
                        initialize: new Data_Maybe.Just(Initialize3.value),
                        finalize: Halogen_Component.defaultEval.finalize
                    });
                    ...
                    return function(dictMonadStore) {
                        var render = function(v) {
                            var authorize = function(mbProfile) {
                                return function(html) {
                                    if (mbProfile instanceof Data_Maybe.Nothing) return Halogen_HTML.slot_()({
                                        reflectSymbol: function() {
                                            return "login";
                                        }
                                    ...
                                    if (mbProfile instanceof Data_Maybe.Just) return html;
                                    throw new Error("Failed pattern match at App.Component.Router (line 154, column 36 - line 158, column 17): " + [
                                        mbProfile.constructor.name
                                    ]);
                                };
                            };
                            return App_Component_HTML_Navbar.navbarPageWrapper(v)(function() {
                                if (v.route instanceof Data_Maybe.Nothing) return Halogen_HTML_Elements.h1_([
                                    Halogen_HTML_Core.text("Oh no! That page wasn't found")
                                ]);
                                if (v.route instanceof Data_Maybe.Just && v.route.value0 instanceof App_Data_Route.Home) return Halogen_HTML.slot_()({
                                    reflectSymbol: function() {
                                        return "home";
                                    }
                                ...
                                if (v.route instanceof Data_Maybe.Just && v.route.value0 instanceof App_Data_Route.Login) return Halogen_HTML.slot_()({
                                    reflectSymbol: function() {
                                        return "login";
                                    }
                                })(Data_Ord.ordUnit)(Type_Proxy["Proxy"].value)(Data_Unit.unit)(App_Page_Login.component(dictMonadEffect)(dictMonadLog)(dictMonadNavigate)(dictMonadUser))({
                                ...
                                if (v.route instanceof Data_Maybe.Just && v.route.value0 instanceof App_Data_Route.Secrets) return authorize(v.currentUser)(Halogen_HTML.slot_()({
                                    reflectSymbol: function() {
                                        return "secrets";
                                    }
                                ...
                                throw new Error("Failed pattern match at App.Component.Router (line 136, column 33 - line 147, column 72): " + [
                                    v.route.constructor.name
                                ]);
                            }());
                        };
                        var initialState = function(v) {
                        ...
                        var handleQuery = function() {
                            var displayRouteChange = function(v) {
                                return function(v1) {
                                    if (v instanceof Data_Maybe.Nothing) return "Setting initial route to /#" + Routing_Duplex.print(App_Data_Route.routeCodec)(v1);
                                    if (v instanceof Data_Maybe.Just) return "Changing route from /#" + (Routing_Duplex.print(App_Data_Route.routeCodec)(v.value0) + (" to /#" + Routing_Duplex.print(App_Data_Route.routeCodec)(v1)));
                                    throw new Error("Failed pattern match at App.Component.Router (line 126, column 30 - line 131, column 51): " + [
                                        v.constructor.name,
                                        v1.constructor.name
                                    ]);
                                };
                            ...
                            return function(v) {
                                return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function(v1) {
                                    ...
                                    return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(App_Data_Route.eqRoute))(maybeOldRoute)(new Data_Maybe.Just(v.value0)))(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function(v1) {
                                        ...
                                        for(var $34 in v1)if (({
                                        }).hasOwnProperty.call(v1, $34)) $33[$34] = v1[$34];
                        ...
                        var handleAction = function(v) {
                            if (v instanceof Initialize4) return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Store_Monad.emitSelected(Halogen_Store_Monad.monadStoreHalogenM(dictMonadStore))(Halogen_Store_Select.selectEq(Data_Eq.eqArray(Data_Eq.eqString))(function(v1) {
                                return v1.recentMessageLog;
                            })))(function(newLogEmitter) {
                                return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(Data_Functor.map(Halogen_Subscription.functorEmitter)(UpdateMessageLog2.create)(newLogEmitter))))(function() {
                            ...
                            if (v instanceof Receive5) return App_Store.updateLocalState(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0);
                            if (v instanceof UpdateMessageLog2) return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function(v1) {
                                ...
                                return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Eq.eqArray(Data_Eq.eqString))(v.value0)(currentLog))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function(v1) {
                                    ...
                                    for(var $41 in v1)if (({
                                    }).hasOwnProperty.call(v1, $41)) $40[$41] = v1[$41];
                                    $40.messageLog = v.value0;
                                    return $40;
                                }));
                            });
                            throw new Error("Failed pattern match at App.Component.Router (line 85, column 20 - line 106, column 46): " + [
                                v.constructor.name
                            ]);
                        };
                        var $$eval = Halogen_Component.mkEval({
                            ...
                            receive: function($46) {
                                return Data_Maybe.Just.create(Receive5.create($46));
                            },
                            initialize: new Data_Maybe.Just(Initialize4.value),
                            finalize: Halogen_Component.defaultEval.finalize
                        });
                        return Halogen_Store_Connect.connect(dictMonadEffect)(dictMonadStore)(Halogen_Store_Select.selectEq(Data_Maybe.eqMaybe(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()({
                            reflectSymbol: function() {
